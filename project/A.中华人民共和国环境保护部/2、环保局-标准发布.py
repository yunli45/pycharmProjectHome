                ...
                for ids, src in enumerate(srcList):
                    ...
                    if 键值对比较 == 'None':
                        ...
                        if str(contResponse) == '<Response [404]>':
                            ...
                            soupCont4 = soup.find_all('div', attrs={'class': 'content_body_box'})
                            soupCont5 = soup.find_all('div', attrs={'class': 'Custom_UnionStyle'})

                            if soupCont1 != [] or soupCont2 != [] or soupCont3 != [] or soupCont4 != [] or soupCont5 != []:
                                if soupCont1 != []:
                                    soupCont = soupCont1
                                elif soupCont2 != []:
                                    soupCont = soupCont2
                                ...
                                print("全文标签除了wzxq_neirong2、content、TRS_Editor、content_body_box还有其他的格式")
                                os._exit(0)
                    else:
                        print("存在该条数据，未保存该数据")
                        pass
...
if __name__ =="__main__":
    ...
    SavePath = 'F:\环保局\标准发布\%s'
    tableName = '环境保护局'
    超链接本地地址 = '/datafolder/环保局/标准发布/'
    来源库名称 = '中华人民共和国生态环境部>环境保护标准>标准发布'
    版权归属 = '中华人民共和国生态环境部'
    来源模块名称 = '标准发布'
