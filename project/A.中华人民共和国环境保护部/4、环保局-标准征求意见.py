...
if __name__ =="__main__":
    ...
    IndexUrl = "http://kjs.mee.gov.cn/hjbhbz/bzzqyj/index.shtml"
    SavePath = 'F:\环保局\标准征求意见\%s'
    tableName = '环境保护局'
    超链接本地地址 = '/datafolder/环保局/标准征求意见/'
    来源库名称 = '中华人民共和国生态环境部>环境保护标准>标准征求意见'
    版权归属 = '中华人民共和国生态环境部'
    来源模块名称 = '标准征求意见'
