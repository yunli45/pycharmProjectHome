...
# 用于解析具体的页面：判断初始的src是否有跳转、是否是附件、以及具体页面数据的提取
    def parePage(self,indexUrl,SavePath,超链接本地地址,来源库名称,来源模块名称,版权归属):
...
if __name__ =="__main__":
    ...
    indexUrl = "http://www.nhfpc.gov.cn/sps/zcwj2/zcwj.shtml"
    SavePath = 'F:\卫计局\食品安全标准与检测评估司\政策文件\%s'
    超链接本地地址 = '/datafolder/卫计局数据校正/食品安全标准与检测评估司/政策文件/'
    来源库名称 = '食品安全标准与检测评估司>政策文件'
    版权归属 = '中华人民共和国国家卫生健康委员会'
    来源模块名称 = '政策文件'
    res =   AdminiStrative.parePage(indexUrl,SavePath,超链接本地地址,来源库名称,来源模块名称,版权归属)
