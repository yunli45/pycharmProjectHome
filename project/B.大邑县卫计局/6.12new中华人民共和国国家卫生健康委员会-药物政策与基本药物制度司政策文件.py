...
if __name__ =="__main__":
    ...
    url = "http://www.nhfpc.gov.cn/yaozs/zcwj2/new_zcwj.shtml"
    SavePath = 'F:\卫计局\药物政策与基本药物制度司\政策文件\%s'
    tableName = '大邑县卫生局数据'
    超链接本地地址 = '/datafolder/卫计局数据校正/药物政策与基本药物制度司/政策文件/'
    来源库名称 = '药物政策与基本药物制度司>政策文件'
