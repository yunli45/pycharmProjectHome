# coding:utf-8
import re
from K河北省.工具包 import 链接数据库, 附件下载程序, 判断url前面的点返回完整的请求地址
...
cont = """
<td class="list-link"><a href="getfile.do?id={AC100113-0000-0000-56CA-F88D00000005}&filename=双公示处罚2018.11.23.xls&type=db" target="_blank">双公示处罚2018.11.23.xls</a></td>
"""
# source_library = '河北省>政府信息公开栏'
# save_path = "E:\行政案例附件\datafolder\河北省\政府信息公开栏"
# annex_local = source_library.replace("<", '/').replace(">", '/')
# cont_1 =dispose_of_data('', 'http://info.hebei.gov.cn/eportal/ui?pageId=6778557&articleKey=6793749&columnId=330110', str(cont), save_path, annex_local)