    ...
    def pare_page_data(self, page_url, table_name, save_path, source_library, province):
        ...
        for page_no in range(1, 10):
            ...
            if page_no == 1:
                ...
                page_url_1 = page_url[:page_url.rfind("currentPage=") + 12] + str(page_no)+"&moduleId=6917fd4269eb4300947ef0182ad52692"
            ...
            rs_soup = rs_soup.find_all('ul', attrs={'class': 'list_ul'})
                ...
                if src_list:
                    for ids, src in enumerate(src_list):
                        ...
                        if title.find('实施情况') != -1:
                            ...
                            cont_soup_1 = cont_soup.find_all('div', attrs={'class': 'article_main'})
                            if cont_soup_1 != []:
                                cont = str(cont_soup_1[0])
                            else:
                                raise Exception(""" 对不起全文没有找到<div class="article_main">这个标签，请查看下具体的情况""" + str(
                            ...
                            info = 提取信息.extracting_information_2(title, cont)
...
if __name__ =="__main__":
    ...
    index_url = "http://www.liuyang.gov.cn:8081/eportal/ui?pageId=2018360&currentPage=1&moduleId=6917fd4269eb4300947ef0182ad52692"  #
    table_name = '行政案例数据表'
    # table_name = '行政案例测试表'
    save_path = "E:\行政案例附件\datafolder\湖南省\浏阳市-住建\%s"
    source_library = '湖南省>浏阳市-住建'
