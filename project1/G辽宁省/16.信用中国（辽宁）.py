...
# 访问网址：get
    ...
    def pare_page_data(self, page_url, table_name, save_path, source_library, province):
        ...
        # for page_no in range(1, 816):
        for page_no in range(802, 816):
            ...
            if rs_list:
                ...
                for ids, src in enumerate(rs_list):
                    ...
                    # 这条数据请求地址
                    id_1 =  src
                    content_src = "http://portal.lncredit.gov.cn/TestUsers/website/ln210000/wsreportingdoublepublicityquery/punishdetail?id="+id_1
...
if __name__ =="__main__":
    ...
    index_url = "http://portal.lncredit.gov.cn/TestUsers/website/ln210000/wsreportingdoublepublicityquery/getPenaltyPage"  #
    ...
    table_name = '行政案例数据表'
    # table_name = '行政案例测试表'
    save_path = "E:\行政案例附件\datafolder\辽宁省\信用中国\%s"
    source_library = '辽宁省>信用中国(辽宁)'
    province = source_library[:source_library.find(">")]
    # AdminiStrative.get_page_data(index_url)
