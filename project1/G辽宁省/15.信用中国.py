...
# 访问网址：get
    ...
    def pare_page_data(self, page_url, table_name, save_path, source_library, province):
        ...
        for page_no in range(1, 3):
            ...
            response = 动态访问.get_index_page_2(page_url_1, page_no)
...
if __name__ =="__main__":
    ...
    index_url = "http://portal.lncredit.gov.cn/TestUsers/website/ln210000/wsreportingdoublepublicityquery/penaltyindex"  #
    ...
    table_name = '行政案例数据表'
    # table_name = '行政案例测试表'
    save_path = "E:\行政案例附件\datafolder\辽宁省\葫芦岛市\%s"
    source_library = '辽宁省>葫芦岛市'
