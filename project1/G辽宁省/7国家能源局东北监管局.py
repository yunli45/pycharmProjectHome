        ...
        for page_no in range(1, 5):
            ...
            if src_list:
                for ids, src in enumerate(src_list):
                    ...
                    cont_response = 动态访问.get_index_page_1(content_src)
                    # print(cont_response)
                    ...
                    if title == '中国证券监督管理委员会行政处罚听证规则':
                        ...
                        cont_2 = 预处理模块.dispose_of_data(page_url, content_src, str(cont_2), save_path)
                        cont = cont_1+cont_2
...
if __name__ =="__main__":
    ...
    table_name = '行政案例数据表'
    # table_name = '行政案例测试表'
    save_path = "E:\行政案例附件\datafolder\辽宁省\国家能源局东北监管局\%s"
    source_library = '辽宁省>国家能源局东北监管局'
