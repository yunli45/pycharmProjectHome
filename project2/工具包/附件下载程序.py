...
def download_data(url, adjunct_name, save_path):
        ...
        # re_png = re.findall(re.compile(r'.*?.png',  re.I),  download_ur_1_1)
...
# download_data('http://xxgk.hainan.gov.cn/qhxxgk/hbj/201811/P020181129666759970247.pdf', 'P020181129666759970247.pdf', 'E:\行政案例附件\datafolder\海南省')