            ...
            if src_list:
                for ids, src in enumerate(src_list):
                    ...
                    if data_id_rs is not None:
                        ...
                        book_num = title[:title.find("号")]
                        punished_people = ''                          # 被处罚人
                        punished_institution = ''                     # 被处罚机构
                        law_enforcement =  '天津海关'                  # 执法机构
                        legal_person = ''                             # 法人
...
def main():
    ...
    for page_no in range(1, 159):
        ...
        page_url = index_url + "/tianjin_customs/427875/427916/427918/427920/2fa9bddc-{0}.html".format(page_no)
        request_type = 'get'
