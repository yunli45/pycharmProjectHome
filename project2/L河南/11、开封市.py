...
def main():
    ...
    index_url = "http://www.hnxmy.gov.cn"
    table_name = '行政案例数据表'
    # table_name = '行政案例测试表'
    source_library = '河南省>畜牧局'
    ...
    #     para = ''
    #     page_url = index_url + "/kfxypt/ywSgsXzcfController.do?getMlXzcfMhJson&commonquery=&page={0}".format(page_no)
    #     request_type = 'get'
