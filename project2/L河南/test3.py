...
class MySpider():
    ...
    """
    def __init__(self, headers, index_url, page_no, page_url, para, save_path, table_name, source_library,annex_local, province):
...
def main():
    ...
    for page_no in range(21, 30):
        para = {
            "page": "{0}".format(page_no),
            "pagesize": "20"
        }
        MySpider(headers,index_url, page_no, page_url, para, save_path, table_name, source_library, annex_local, province).parse_page()
