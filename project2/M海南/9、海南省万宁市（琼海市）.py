...
def main():
    ...
    for page_no in range(1, 18):
        ...
        page_url = index_url + "/was5/search/search_hnpage.jsp?subcat1=&subcat2=&name2=&Publisher=wnxxgk&PreKeyword=行政处罚&dengyu1=1&Referer=&siteid=&type=a&page={0}".format(page_no)
        request_type = 'get'
