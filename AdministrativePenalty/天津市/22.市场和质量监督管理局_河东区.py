...
class Utils(object):
    ...
    def parsePage(self,url=None,pageNo=None,baseUrl=" ",path="F:\行政处罚数据\天津\市场和质量监督管理局_河北区\%s"):
        if pageNo =="1":
...
if __name__ =="__main__":
    # 共计353页
    url ="http://scjg.tj.gov.cn/hebei/zwgk/xzcfxx/index"
