...
class Utils(object):
    ...
    def parsePage(self,url=None,pageNo=None,baseUrl="http://www.btgaj.gov.cn",path="F:\行政处罚数据\内蒙古\包头_网上公安厅\%s"):
        ...
        responseList = responseList.find_all('td',attrs={'id':'right_middle'})
        # print(responseList)
...
if __name__ =="__main__":
    # 共计353页
    url ="http://www.btgaj.gov.cn/fsmcms/html/main/col16/column_16_"
