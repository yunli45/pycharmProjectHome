...
'Cookie': 'UM_distinctid=16532c0517d14e-02abbe80f1ce0f-5e442e19-1fa400-16532c0517fb6f; BIGipServerpool_web'=392194058.20480.0000;CNZZDATA1272831274'='1860617032-1534841909-http%253A%252F%252Fcf.nmds.gov.cn%252F%7C1534841909',
'Host': 'cf.nmds.gov.cn',
'If-Modified-Since': 'Tue, 19 Jun 2018 01:04:38 GMT',
'If-None-Match': 'W/"5b2856a6-33fa"',
'Upgrade-Insecure-Requests': 1',
'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36'
}
        self.OnlyID = 1
        self.showId = 12335500
    ...
    def parsePage(self,url=None,pageNo=None,baseUrl="http://www.linhe.gov.cn",path="F:\行政处罚数据\内蒙古\赤峰市 _地方税务局\%s"):
        ...
        responseList = responseList.find_all('div',attrs={'class':'gailan_R_con'})
        print(responseList)
...
if __name__ =="__main__":
    # 共计353页
    url ="http://cf.nmds.gov.cn/xxgk/yfxz/xzcfgs/index"
