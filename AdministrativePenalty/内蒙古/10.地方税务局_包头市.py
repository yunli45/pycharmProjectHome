...
class Utils(object):
    ...
    def parsePage(self,url=None,pageNo=None,baseUrl="http://www.btgaj.gov.cn",path="F:\行政处罚数据\内蒙古\地方税务局_包头市\%s"):
        if pageNo =="1":
...
if __name__ =="__main__":
    # 共计353页
    url ="http://bt.nmds.gov.cn/xxgk/yfxz/xzcfgs/index"
