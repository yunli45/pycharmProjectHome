...
if __name__ =="__main__":
    # 共计353页
    url ="http://www.ngsh.gov.cn/zfxxgs/txxgsj/List_"
    baseUrl="http://www.ngsh.gov.cn"
    SavePath = "F:\行政处罚数据\宁夏\宁夏工商局\%s"
    RSaddress ="宁夏回族自治区"
    RSarea ="红寺堡开发区市场监督管理局"
    RSFalseHeadlines ="宁夏回族自治区的红寺堡开发区市场监督管理局数据"
