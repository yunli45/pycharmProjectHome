...
def replaceLable(ConetentResponseSoupOld):
    ...
    ConetentResponseSoupOld = re.sub("<b.*?>", '', ConetentResponseSoupOld, flags=re.S | re.M).replace("</b>",
                                                                                                       '')
    # 去除TAB空格
    ConetentResponseSoupOld = re.sub('    ','',ConetentResponseSoupOld)
    ConetentResponseSoupOld = re.sub('	','',ConetentResponseSoupOld)
    ...
    ConetentResponseSoupOld = re.sub('<style.*?>.*?</style>','',ConetentResponseSoupOld, flags=re.S | re.M)
    ...
    ConetentResponseSoupOld = re.sub('<p>[   ]{1,1000}</p>', '', ConetentResponseSoupOld)
